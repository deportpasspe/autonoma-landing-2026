...
const exportDir = join(exportRoot, "autonoma-arequipa");
const zipPath = join(exportRoot, "autonoma-arequipa.zip");
...
const readme = `Landing Nueva Sede Arequipa — export limpio (HTML / CSS / JS)
=================================================
...
try {
  execFileSync(
    "zip",
    ["-r", "-q", zipPath, "autonoma-arequipa", "-x", "*.DS_Store", "-x", "**/.DS_Store"],
    {
      cwd: exportRoot,
      stdio: "inherit",
    },
